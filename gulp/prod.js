...
gulp.task("move-asset:prod", function(done) {
  ...
  gulp.src("./src/asset/icon/**/*").pipe(changed("./dist/icon/")).pipe(gulp.dest("./dist/icon/"));
  gulp.src("./src/asset/font/**/*").pipe(changed("./dist/font/")).pipe(gulp.dest("./dist/font/"));
  gulp.src("./src/asset/video/**/*").pipe(changed("./dist/video/")).pipe(gulp.dest("./dist/video/"));
  gulp.src("./src/asset/file/**/*").pipe(changed("./dist/file/")).pipe(gulp.dest("./dist/file/"));
  done()
})
